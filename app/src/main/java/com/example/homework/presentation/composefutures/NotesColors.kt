...
fun secondColors(
    ...
    secondaryVariant: Color = Color(0xFF5c677d),
    background: Color = Color(0XFF7d8597),
    surface: Color = Color(0xFFA6ABB6),
    error: Color = Color(0xFFC6C9CF),
    onPrimary: Color = Color.Black,
...
fun thirdColors(
    ...
    surface: Color = Color(0xFF9d4edd),
    error: Color = Color(0xFF7b2cbf),
    onPrimary: Color = Color.Black,
    onSecondary: Color = Color.Black,
    onBackground: Color = Color.White,
    onSurface: Color = Color.White,
    onError: Color = Color.Black,
    notEnabled: Color = Color(0xFF7b2cbf),
    rippleColor: Color = Color(0XFF5a189a),
): NotesColors = NotesColors(
    primary,
    primaryVariant,
    secondary,
